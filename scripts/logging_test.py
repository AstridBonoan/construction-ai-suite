...
def run_logging_test() -> int:
  ...
  logger.info('Simulated token: access_token: "abcd1234efgh5678ijklmnopqrst" should be redacted')
  logger.error('Simulated error with api_key: "REPLACE_ME_API_KEY" should be redacted')
  ...
  if errs:
    ...
    if os.getenv('FAIL_ON_LOG_ERRORS', '0') == '1':
      ...
      print('Send errors present but continuing (set FAIL_ON_LOG_ERRORS=1 to make CI fail)')
      return 0
