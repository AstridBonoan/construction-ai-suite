...
df['planned_duration_days'] = pd.to_numeric(df.get('planned_duration_days'), errors='coerce')
...
if len(vals) > 0:
    ...
    print('Percentiles (0,1,5,10,25,50,75,90,95,99,100):', ', '.join([f'{p:.2f}' for p in pct]))
    print('\nTop value counts:')
