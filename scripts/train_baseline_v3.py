#!/usr/bin/env python3
"""Train Baseline v3: uses cleaned v3 splits and trains RandomForest with RandomizedSearchCV.

Saves:
- models/v3/baseline_project_delay_model_v3.pkl
...
def train_v3(random_state: int = 42, n_iter: int = 12):
